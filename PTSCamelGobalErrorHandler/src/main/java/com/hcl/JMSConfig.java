...
/*Configration class for MQ & Camel*/
...
public class JMSConfig {
	...
	@Bean
	public JmsComponent createJmsComponent(final ConnectionFactory connectionFactory,final JmsTransactionManager 
			jmsTransactionManager,@Value("{max.concurrent.consumers}") final int maxConcurrentConsumers) {
